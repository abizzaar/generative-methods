...
((root, factory) => {
  ...
  class Vector {
    ...
    setToElliptical(w, h, theta) {
      this.coords[0] = w * Math.cos(theta)
      this.coords[1] = h * Math.sin(theta)
  ...
  Vector.multiply = function (v1, v2) {
    return new Vector(v1.coords[0] * v2.coords[0], v1.coords[1] * v2.coords[1])
  }
